...
const Dock = () => {
  return (
    <div className="flex justify-center sticky bottom-2 pt-3">
      <div className="dark:bg-black/70 bg-white/70 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-xl flex">
        {[
          {
            title: "GitHub",
            svgPath: [
            ...
            viewBox: "0 0 24 24",
            link: "https://github.com/alenjoy7",
          },
          {
            title: "LinkedIn",
            svgPath: [
              "M 8 3.0097656 C 4.53 3.0097656 2.0097656 5.0892187 2.0097656 7.9492188 C 2.0097656 10.819219 4.59 12.990234 8 12.990234 C 11.47 12.990234 13.990234 10.870625 13.990234 7.890625 C 13.830234 5.020625 11.36 3.0097656 8 3.0097656 z M 3 15 C 2.45 15 2 15.45 2 16 L 2 45 C 2 45.55 2.45 46 3 46 L 13 46 C 13.55 46 14 45.55 14 45 L 14 16 C 14 15.45 13.55 15 13 15 L 3 15 z M 18 15 C 17.45 15 17 15.45 17 16 L 17 45 C 17 45.55 17.45 46 18 46 L 27 46 C 27.552 46 28 45.552 28 45 L 28 30 L 28 29.75 L 28 29.5 C 28 27.13 29.820625 25.199531 32.140625 25.019531 C 32.260625 24.999531 32.38 25 32.5 25 C 32.62 25 32.739375 24.999531 32.859375 25.019531 C 35.179375 25.199531 37 27.13 37 29.5 L 37 45 C 37 45.552 37.448 46 38 46 L 47 46 C 47.55 46 48 45.55 48 45 L 48 28 C 48 21.53 44.529063 15 36.789062 15 C 33.269062 15 30.61 16.360234 29 17.490234 L 29 16 C 29 15.45 28.55 15 28 15 L 18 15 z",
            ],
            viewBox: "0 0 50 50",
            link: "https://www.linkedin.com/in/alenjoy-7",
          },
          {
            title: "Gmail",
            svgPath: [
          ...
          <Link
            ...
            aria-label={title}
            title={title}
            download={title === "Resume" ? "" : undefined}
          >
            <div className="bg-black dark:bg-white m-2 rounded-lg p-1 fill-white dark:fill-black hover:scale-110 transform transition text-white dark:text-black w-10 cursor-pointer">
              <svg
                role="img"
                viewBox={viewBox}
